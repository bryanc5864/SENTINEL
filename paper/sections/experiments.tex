...
head fine-tuned on 2,861 co-registered satellite--in situ WQ pairs: 847
from GRQA (2015--2020) and EPA WQP spanning 170 geographic cells across
105 countries, plus 2,014 new pairs collected from 195 USGS NWIS stations
with GPS-precise ($\sim$10\,m) coordinates and tightly co-registered
Sentinel-2 tiles ($\pm$1.5\,km, $\pm$3\,days). Training: masking ratio
75\%, learning rate $3 \times 10^{-4}$, 200 epochs total.
...
\paragraph{BioMotion.}
Phase 1: diffusion denoising pretraining on 5,000 Daphnia locomotion
trajectories (1000 timesteps, noise schedule $\beta \in [10^{-4},
0.02]$). Phase 2: anomaly classification fine-tuning using
diffusion-derived trajectory features. Trajectories span 4 anomaly types:
erratic movement, freezing, spinning, and altered velocity.
