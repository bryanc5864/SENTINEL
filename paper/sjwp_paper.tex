...
\caption{Detection lead time for all 31 real events. Gold = real USGS inference (6 events, mean 66 days). Teal = NEON real sensor events (6). Blue = research-validated (21). Green = historical estimates.}
\label{fig:detection}
\end{figure}
